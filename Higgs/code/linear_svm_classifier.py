...
model = SVMWithSGD.train(vectorized_data, iterations=60)
train_end = time.time()
...
res_fh = open('../result/NEW_PROPER_linear_svm_classifier_result.txt','w')
res_fh.write(result)
res_fh.close()
